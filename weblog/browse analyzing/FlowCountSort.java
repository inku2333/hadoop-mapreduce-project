...
//			try {
//				weblogBean.setHotCommodity(fields[2]);	//手机号
//				weblogBean.setPopularCategories(fields[3]);
//				context.write(weblogBean, new IntWritable(1));
//				
//			} catch (Exception e) {
//				e.printStackTrace();
//			}
...
//		new FlowCount().new FlowCountMapper();
//		new FlowCountMapper();					//static内部类
...
//				job.setJar("/home/hadoop/wordcount.jar");	 hadoop -jar xxxx.jar 包.类
		...
		//指定要处理的数据所在的位置
//		FileInputFormat.setInputPaths(job, "hdfs://hadoop-mini11:9000/flow/count/");	//args[0]
		FileInputFormat.setInputPaths(job, "D:/flow/newinput/");
		//指定处理完成之后的结果所保存的位置
//		FileOutputFormat.setOutputPath(job, new Path("hdfs://hadoop-mini11:9000/flow/output/"));	////args[1]
